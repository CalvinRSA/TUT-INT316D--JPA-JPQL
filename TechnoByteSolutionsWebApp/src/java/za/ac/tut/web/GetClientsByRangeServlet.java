 ...
 * @author calvin
 */
public class GetClientsByRangeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ClientsData> clients = fac.getClientsByRange(min, max);
        request.setAttribute("clients", clients);
        
        RequestDispatcher disp = request.getRequestDispatcher("get_range_outcome.jsp");
